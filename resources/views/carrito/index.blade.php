            ...
            <div class="col-md-6">
                <div class="card">
                    ...
                    <div class="card-body">
                        @php
                            $usuario = Auth::user();
                            $direccion = $usuario ? ($usuario->direccion ?: 'No especificada') : 'No especificada';
                            $telefono = $usuario ? ($usuario->telefono ?: 'No especificado') : 'No especificado';
                        @endphp
                        <p class="mb-2"><strong>Dirección:</strong> {{ $direccion }}</p>
                        <p class="mb-2"><strong>Teléfono:</strong> {{ $telefono }}</p>
