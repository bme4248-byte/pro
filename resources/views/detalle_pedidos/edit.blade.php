...
<div class="container-fluid px-4">
    <h1 class="mt-4">Editar Detalle de Pedido</h1>
                        ...
                        <div class="mb-3">
                            ...
                            <select class="form-control @error('pedido_id') is-invalid @enderror" 
                                ...
                                @foreach($pedidos as $pedido)
                                    <option value="{{ $pedido->id }}" {{ old('pedido_id', $detallePedido->pedido_id) == $pedido->id ? 'selected' : '' }}>
                            ...
                            <select class="form-control @error('producto_id') is-invalid @enderror" 
                                ...
                                @foreach($productos as $producto)
                                    <option value="{{ $producto->id }}" 
                                            ...
                                            {{ old('producto_id', $detallePedido->producto_id) == $producto->id ? 'selected' : '' }}>
                    ...
                    <div class="col-md-6">
                        <div class="mb-3">
                            ...
                            <select class="form-control @error('vendedor_id') is-invalid @enderror" 
                                ...
                                @foreach($vendedores as $vendedor)
                                    <option value="{{ $vendedor->id }}" {{ old('vendedor_id', $detallePedido->vendedor_id) == $vendedor->id ? 'selected' : '' }}>
                            ...
                            <div class="col-md-6">
                                <div class="mb-3">
                                    ...
                                    <input type="number" class="form-control @error('cantidad') is-invalid @enderror" 
                                           id="cantidad" name="cantidad" value="{{ old('cantidad', $detallePedido->cantidad) }}" min="1" required>
                                    @error('cantidad')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                            ...
                            <div class="col-md-6">
                                <div class="mb-3">
                                    ...
                                    <input type="number" step="0.01" class="form-control @error('precio_unitario') is-invalid @enderror" 
                                           id="precio_unitario" name="precio_unitario" value="{{ old('precio_unitario', $detallePedido->precio_unitario) }}" min="0" required>
                        ...
                        <div class="mb-3">
                            ...
                            <div class="form-control" id="subtotal-calculado" style="background-color: #f8f9fa;">
                                ${{ number_format($detallePedido->subtotal, 2) }}
                            </div>
                        </div>
                    </div>
                </div>
